...
async function findEpisodesExercises(client) {
  ...
  const allTitle = results2.map((episode) => episode.title);

  console.log(`The episodes that Bob Ross painted a CLIFF are ${allTitle}`);
  ...
  const allTitle1 = results3.map((episode) => episode.title);

  console.log(
    `The episodes that Bob Ross painted a CLIFF and a LIGHTHOUSE are ${allTitle1}`
  );
}
